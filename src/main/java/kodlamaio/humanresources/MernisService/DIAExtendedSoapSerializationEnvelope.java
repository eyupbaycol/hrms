...
public class DIAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DIADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DIAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DIADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DIADateTimeConverter dateTimeConverter = new DIAStandardDateTimeConverter();

    public DIAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DIAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DIAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DIAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DIAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DIAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }

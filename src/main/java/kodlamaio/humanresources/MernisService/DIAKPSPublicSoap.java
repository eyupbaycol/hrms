...
public class DIAKPSPublicSoap
{
    ...
    public DIAKPSPublicSoap(){}

    public DIAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DIAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DIAExtendedSoapSerializationEnvelope envelope= new DIAExtendedSoapSerializationEnvelope(DIAExtendedSoapSerializationEnvelope.VER11);
